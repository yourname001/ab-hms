            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio">
                            <div class="custom-control custom-radio">
                                <input required type="radio" class="custom-control-input" name="remarks" value="confirmed" id="paymentConfirmed">
                                <label class="custom-control-label" for="paymentConfirmed">Confirmed</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input required type="radio" class="custom-control-input" name="remarks" value="denied" id="paymentDenied">
                    ...
                    <div class="form-group" id="amount">
                        ...
                        <input type="number" class="form-control" name="amount_confirmed" id="amountConfirmed">
                    </div>
                </div>
